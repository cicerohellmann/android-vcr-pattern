...
import com.hellmannratti.zombie.replay.TapeLoader
import com.hellmannratti.zombie.ui.theme.ZombieTheme
...
class MainActivity : ComponentActivity() {
    val app by lazy { ZombieApp.from(this) }
    ...
    private fun loadTapeFromUri(uri: Uri) {
        lifecycleScope.launch {
            try {
                ...
                val patterns = listOf(
                    com.hellmannratti.zombie.replay.UrlPattern.fromRetrofitStyle("https://pokeapi.co/api/v2/pokemon/{id}")
                )
                ...
                val replayer = com.hellmannratti.zombie.replay.ReplayerInterceptor() { Mode.REPLAY }.apply {
                    this.tape = tape
                }
    ...
    fun downloadSessionLog() {
        lifecycleScope.launch {
            try {
                ...
                val fileName = "zombie_session_${System.currentTimeMillis()}.ndjson"
